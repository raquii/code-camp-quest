...
export const MAP_TABLE = [
    ...
    [RED_TILE, RED_TILE, RED_TILE, RED_TILE, RED_TILE, RED_TILE, RED_TILE, RED_TILE, RED_TILE, RED_TILE, RED_TILE, RED_TILE],
    [RED_TILE, RED_TILE, RED_TILE, RED_TILE, RED_TILE, RED_TILE, RED_TILE, RED_TILE, RED_TILE, RED_TILE, RED_TILE, RED_TILE],
    [RED_TILE, RED_TILE, RED_TILE, RED_TILE, RED_TILE, ACTION_TILE, GREEN_TILE, RED_TILE, RED_TILE, RED_TILE, RED_TILE, RED_TILE],
    ...
    [RED_TILE, RED_TILE, GREEN_TILE, GREEN_TILE, GREEN_TILE, GREEN_TILE, GREEN_TILE, GREEN_TILE, GREEN_TILE, ACTION_TILE, RED_TILE, RED_TILE],
